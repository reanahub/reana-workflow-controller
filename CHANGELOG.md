...
## [0.9.5](https://github.com/reanahub/reana-workflow-controller/compare/0.9.4...0.9.5) (2026-08-25)
...
* **python:** upgrade to Flask 3.x ([#678](https://github.com/reanahub/reana-workflow-controller/issues/678)) ([332aa83](https://github.com/reanahub/reana-workflow-controller/commit/332aa839f61bd145b4a16cdb28c615aa3673e554))
...
* **config:** propagate minimum Kubernetes job user ID env var ([#684](https://github.com/reanahub/reana-workflow-controller/issues/684)) ([9bfa405](https://github.com/reanahub/reana-workflow-controller/commit/9bfa405df1db33781d9fd9fc16e5e6590331a3a1))
...
* **docker:** externalise uWSGI controller configuration ([#683](https://github.com/reanahub/reana-workflow-controller/issues/683)) ([2835455](https://github.com/reanahub/reana-workflow-controller/commit/28354556f481ac20c33f69c9829a67ac2293e812))
...
* **manager:** harden workflow run and session pods ([#694](https://github.com/reanahub/reana-workflow-controller/issues/694)) ([ae7f5f9](https://github.com/reanahub/reana-workflow-controller/commit/ae7f5f908700749178d1ea67c12ccb855f5d8e77))
...
* **manager:** set runAsNonRoot on workflow-engine container ([#685](https://github.com/reanahub/reana-workflow-controller/issues/685)) ([11b19db](https://github.com/reanahub/reana-workflow-controller/commit/11b19dbc4a968aba56811bea2b041126f84691f0))
...
* **rest:** limit workspace file listing and add forced GC ([#657](https://github.com/reanahub/reana-workflow-controller/issues/657)) ([dc8bb22](https://github.com/reanahub/reana-workflow-controller/commit/dc8bb2220e91f85ff4bebe7bc1fc30863f56c7ce)), closes [#644](https://github.com/reanahub/reana-workflow-controller/issues/644)
* **validation:** sandbox workflow specification loading ([#693](https://github.com/reanahub/reana-workflow-controller/issues/693)) ([9ca3258](https://github.com/reanahub/reana-workflow-controller/commit/9ca3258e644cdfaddabef3f79cdad6324375456d))


### Bug fixes

* **config:** default OpenSearch user/password to empty ([#688](https://github.com/reanahub/reana-workflow-controller/issues/688)) ([f6343b6](https://github.com/reanahub/reana-workflow-controller/commit/f6343b68c178d03039c3c838af6207431c99b890))
* **config:** harmonise and align REANA host port handling ([#680](https://github.com/reanahub/reana-workflow-controller/issues/680)) ([5b6742d](https://github.com/reanahub/reana-workflow-controller/commit/5b6742deb4db1dca1c9f865396588de5bd9a6837))
* **config:** refuse running with an unset SECRET_KEY ([#688](https://github.com/reanahub/reana-workflow-controller/issues/688)) ([7b1fbd3](https://github.com/reanahub/reana-workflow-controller/commit/7b1fbd3c6385976745c88eefb63d412082652101))
...
* **config:** use glob for egg-info in flake8 exclude ([#650](https://github.com/reanahub/reana-workflow-controller/issues/650)) ([8092761](https://github.com/reanahub/reana-workflow-controller/commit/809276132a101ac40b8bd26f105286155f9fc45f))
* **consumer:** bypass kubernetes 36 pod log deserialiser ([#689](https://github.com/reanahub/reana-workflow-controller/issues/689)) ([895b55e](https://github.com/reanahub/reana-workflow-controller/commit/895b55e3b9abe813524e86ec026850ddc3298089))
...
* **dask:** create group-writable worker files ([#695](https://github.com/reanahub/reana-workflow-controller/issues/695)) ([0654955](https://github.com/reanahub/reana-workflow-controller/commit/065495532407579dc31eb1468c63d4b11d5324e7))
* **dask:** fix pulling from private container registries ([#677](https://github.com/reanahub/reana-workflow-controller/issues/677)) ([b6eafc5](https://github.com/reanahub/reana-workflow-controller/commit/b6eafc5177b7ca819118753318b4491f6f2ff6cd))
...
* **factory:** initialise umask during app startup ([#695](https://github.com/reanahub/reana-workflow-controller/issues/695)) ([d1ec042](https://github.com/reanahub/reana-workflow-controller/commit/d1ec042f61bc3e64c8f9f1d5223cbb64ffb0a737))
* **git:** update .gitignore to exclude modules directory ([#687](https://github.com/reanahub/reana-workflow-controller/issues/687)) ([c797ed0](https://github.com/reanahub/reana-workflow-controller/commit/c797ed0a1f67b7b315ce5eba9a54612827509ff1))
...
* **pytest:** drop pytest-reana for reana-commons[tests] ([#681](https://github.com/reanahub/reana-workflow-controller/issues/681)) ([99f9d86](https://github.com/reanahub/reana-workflow-controller/commit/99f9d86a6e1947dd8b55bd23f875d083d74f5291))
* **rest:** adapt to non-dynamic relationships ([#679](https://github.com/reanahub/reana-workflow-controller/issues/679)) ([9b15870](https://github.com/reanahub/reana-workflow-controller/commit/9b158702893d1af4747b8a5291b12a185c670273))
...
* **release-please:** upgrade action to v5 ([#697](https://github.com/reanahub/reana-workflow-controller/issues/697)) ([cec9326](https://github.com/reanahub/reana-workflow-controller/commit/cec9326d63ec29d885e80323b6a8b9a0038334b7))
...
* **run-tests:** improve old DB container cleanup ([#678](https://github.com/reanahub/reana-workflow-controller/issues/678)) ([2ac3c32](https://github.com/reanahub/reana-workflow-controller/commit/2ac3c32633792a9ab0c4cebf54d4fb9d5e6b470a))
